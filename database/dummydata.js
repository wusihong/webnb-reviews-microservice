...
var reviewsQueryStr = `INSERT INTO reviews (reviewer_id, room_id, review_date, review_text, review_in_english, review_text_eng, has_host_response, host_reply_text, stars_accuracy, stars_communication, stars_location, stars_checkin, stars_cleanliness, stars_value) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);`;
...
var createReviewsTableData = () => {
  ...
  for (var i = 0; i < NUM_OF_MESSAGES; i++) {
    dummyData.push({
      ...
      review_in_english: getRandomBoolean(),
